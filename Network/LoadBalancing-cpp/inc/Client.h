...
namespace ExitGames
{
	namespace LoadBalancing
	{
		...
		{
		public:
			Client(LoadBalancing::Listener& listener, const Common::JString& applicationID, const Common::JString& appVersion, nByte connectionProtocol=Photon::ConnectionProtocol::DEFAULT, bool autoLobbyStats=false, bool useDefaultRegion=true);
			virtual ~Client(void);
